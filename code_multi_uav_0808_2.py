...
def main_func(alpha):
    ...
    #    print(f'{idx_sim:3d}/{N_sim:3d}\n')
        ...
        if (dist_min < 100):
            ...
            uxy_opt_global[ac0_idx,:] = collision_uav_optimal_tracking_control(alpha,state_aircraft0,state_aircraft1,state_tracking,J_val_opt0,uxy_opt_body0,all_samples_in_body_frame0,dcm_from_body_to_global0)
            uxy_opt_global[ac1_idx,:] = collision_uav_optimal_tracking_control(alpha,state_aircraft1,state_aircraft0,state_tracking,J_val_opt1,uxy_opt_body1,all_samples_in_body_frame1,dcm_from_body_to_global1)
