...
#        print("alpha: ",alpha/100)
        ...
        for i in range(N_sim):
            ...
            if eff == -1:
                ...
                e = np.append(e,eff)
#        mean_arr = np.append(mean_arr,np.mean(e))
#        var_arr = np.append(var_arr,np.var(e))
        wr.writerow([p, np.mean(e), np.var(e)])
        print([p, np.mean(e), np.var(e)])
#        print("mean:", np.mean(e),"var:", np.var(e))
f.close()